            ...
            <div id="layoutSidenav_content">
                <main>
                  ...
                  <div class="container-fluid px-4">
                    <div>
    <router-link to="/tenant" class="d-none">Tenants</router-link>
    <router-link to="/manager" class="d-none">Tenants</router-link>
    <router-link to="/property" class="d-none">Tenants</router-link>
    <router-link to="/apartment" class="d-none">Tenants</router-link>
    <router-link to="/pay" class="d-none">Tenants</router-link>
